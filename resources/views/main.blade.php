...
<div class="d-flex" id="wrapper">
    ...
    <div class="border-end bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/prices">Prices</a>
        </div>
    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                        @guest
                            <li class="nav-item active"><a class="nav-link" href="/home">Sign in</a></li>
                        @else
                            <li class="nav-item active"><a class="nav-link" href="/home">{{ Auth::user()->name }}</a></li>
                        @endguest
                    </ul>
                </div>
            </div>
